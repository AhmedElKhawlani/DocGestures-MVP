...
from new_consultation import show_new_consult
...
# Create main window
principale = Tk()
principale.title("DOC GESTURES - Clinic Management")
...
button_new_consultation = Button(principale, text="New Consultation", command=show_new_consult)
