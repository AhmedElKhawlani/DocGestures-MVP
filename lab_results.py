...
def get_info():
    ...
    try:
        ...
        (date_consult, motif_consult, antecedent_consult, examens_consult,
         ordonance_consult, bilan_consult) = tuple(data[2:8])
...
def save_record():
    try:
        ...
        stat = (""" UPDATE Consultations SET Test_Results = """ + bilan_res +
                """ Specialist_Advice = """ + specialiste_avis[:-2] +
                """ WHERE ID = """ + ID)
        cur.execute(stat)
        BD.commit()
...
def show_resultat_bilan():
    ...
    global entry_bilan, entry_controle1, entry_controle2
    global entry_resultat, entry_specialiste, entry_avisspe
    ...
    button_save_to_db = Button(resultat_bilan, text="Save data",
                               command=save_record)
    ...
    button_get_data.grid(column=10, row=1, padx=10, pady=10, columnspan=10,
                         rowspan=2)
    entry_motif.grid(column=5, row=4, padx=10, pady=10, columnspan=10,
                     rowspan=3)
    entry_antecedent.grid(column=5, row=10, padx=10, pady=10, columnspan=10,
                          rowspan=3)
    entry_examen.grid(column=22, row=4, padx=10, pady=10, columnspan=10,
                      rowspan=3)
    entry_ordonnance.grid(column=22, row=10, padx=10, pady=10, columnspan=10,
                          rowspan=3)
    entry_bilan.grid(column=5, row=28, padx=10, pady=10, columnspan=10,
                     rowspan=3)
    entry_resultat.grid(column=22, row=28, padx=10, pady=10, columnspan=10,
                        rowspan=3)
    entry_specialiste.grid(column=5, row=40, padx=10, pady=10, columnspan=10,
                           rowspan=3)
    entry_avisspe.grid(column=22, row=40, padx=10, pady=10, columnspan=10,
                       rowspan=3)
    entry_controle1.grid(column=5, row=52, padx=10, pady=10, columnspan=10,
                         rowspan=3)
    entry_controle2.grid(column=22, row=52, padx=10, pady=10, columnspan=10,
                         rowspan=3)
    button_save_to_db.grid(column=26, row=56, padx=10, pady=10, columnspan=10,
                           rowspan=2)
